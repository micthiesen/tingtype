...
Codex is the primary coding harness. Keep project instructions in `AGENTS.md`;
`CLAUDE.md` links here for compatibility. Update this file when work establishes
or changes a durable project convention.
